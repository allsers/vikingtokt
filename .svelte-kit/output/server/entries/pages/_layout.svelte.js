...
function Header($$payload, $$props) {
  push();
  var $$store_subs;
  $$payload.out += `<header class="svelte-1em0pko"><nav class="svelte-1em0pko"><ul class="svelte-1em0pko"><li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/crew" ? "page" : void 0)} class="svelte-1em0pko"><a${attr("href", `${stringify(base)}/crew`)} class="svelte-1em0pko">Crew</a></li> <li id="flex"${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/" ? "page" : void 0)} class="svelte-1em0pko"><img id="logo"${attr("src", logo)} alt="logo" class="svelte-1em0pko"> <a${attr("href", `${stringify(base)}/`)} class="svelte-1em0pko">Vargrclan</a></li> <li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/shop" ? "page" : void 0)} class="svelte-1em0pko"><a${attr("href", `${stringify(base)}/shop`)} class="svelte-1em0pko">Shop</a></li></ul></nav></header>`;
